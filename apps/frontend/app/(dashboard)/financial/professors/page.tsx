            ...
            <table className="min-w-full text-sm">
              <thead>
                <tr className="bg-background">
                  ...
                  <th
                    className="px-3 py-2.5 text-right text-xs font-semibold text-text-secondary uppercase"
                    title={t("financial.payroll.restHint")}
                  >
                    {t("financial.payroll.remainingBalance", "Balance")}
                  </th>
                  <th className="px-3 py-2.5 text-left text-xs font-semibold text-text-secondary uppercase">
