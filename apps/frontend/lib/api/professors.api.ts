...
export const professorsApi = {
  ...
  create: (data: { field_id: string; full_name: string; phone: string; email?: string; user_id?: string }) =>
    ApiClient.post<Professor>("/professors", data),
  update: (id: string, data: { full_name?: string; phone?: string; email?: string; user_id?: string; is_active?: boolean }) =>
