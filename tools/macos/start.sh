...
if [[ ! -f "$BACKEND_ENV" ]]; then
  ...
  keys_to_strip="SCHOOL_NAME|SCHOOL_SLUG|DATABASE_URL|DATABASE_NAME|DATABASE_USER|DATABASE_PASSWORD|POSTGRES_SUPERUSER_PASSWORD|JWT_SECRET|JWT_REFRESH_SECRET|SEED_ADMIN_NAME|SEED_ADMIN_EMAIL|SEED_ADMIN_PASSWORD|GITHUB_TOKEN"
